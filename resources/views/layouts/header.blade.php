                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        <a href="{{ route('dashboard.index') }}" class="m-brand__logo-wrapper">
                            <img alt="" src="{{ setting('logo', asset('assets/demo/default/media/img/logo/logo_default_dark.png')) }}" />
                        </a>
                    </div>
                                        ...
                                        <div class="m-dropdown__body">
                                            <div class="m-dropdown__content">
                                                <ul class="m-nav m-nav--skin-light">
                                                    ...
                                                    <x-nav-item link="{{ route('system.users.profile', logged_user()->id) }}" text="My Profile" icon="flaticon-profile-1" />
                                                    <x-nav-item link="header/profile.html" text="Support" icon="flaticon-lifebuoy" />
